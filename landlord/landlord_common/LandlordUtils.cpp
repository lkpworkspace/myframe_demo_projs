...
std::string LandlordUtils::SerialMsg(::google::protobuf::Message* msg)
{
...
::google::protobuf::Message* LandlordUtils::DeserialMsg(std::string& dat)
{
    using namespace ::google::protobuf;
    using namespace landlord;
    bool b;
